...
export const INSIGHTS: Insight[] = [
...

  {
    ...
    body: [
      ...
      { t: 'p', text: 'A semi at 7 percent against a flat 300 dollars a week breaks even at roughly 4,286 dollars of weekly linehaul. Gross 6,000 a week and the percentage costs 420 while the flat costs 300, so the flat fee saves you 120 a week. Gross 3,000 and the percentage costs 210, so the percentage wins.' },
      { t: 'h2', text: 'The part people get wrong' },
      { t: 'p', text: 'The percentage should apply to linehaul only. Not fuel surcharge, not detention, not layover, not lumper reimbursement. If a dispatcher is taking a percentage of your fuel surcharge, your effective rate is materially higher than the number on the agreement, and the break-even shifts against you.' },
  ...
  },
  {
    ...
    body: [
      ...
      { t: 'ul', items: [
        'Spot rates remain sensitive to fuel movement, so linehaul-only fee structures protect carriers better than percentage-of-total arrangements.',
