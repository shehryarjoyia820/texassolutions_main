...
const BASE_SERVICES: Service[] = [
...

  {
    ...
    interactiveTitle: 'Dispatch fee calculator',
    startingPriceRow: 'semi',
    problem: {
    ...
    subServices: [
      { slug: 'box-truck-hotshot', name: 'Box truck and hotshot', summary: 'Box trucks, straight trucks and hotshot trailers, 8-10% of weekly gross (OTR).', body: 'The lanes and load boards for box truck and hotshot work are different from semi freight. We run them daily and know which brokers pay on time.', deliverables: ['Daily load booking', 'Rate negotiation', 'Broker setup', 'Invoicing support', 'Lane planning'], keyword: 'box truck dispatch service' },
      { slug: 'semi-dispatch', name: 'Semi dispatch', summary: 'Dry van, reefer, flatbed, step deck and power only.', body: 'Equipment-specific dispatch with the permits, securement and temperature rules that go with it, at 5-6% of weekly gross for OTR semis. No flat rate.', deliverables: ['Equipment-matched loads', 'Permit and securement guidance', 'Rate negotiation', 'Broker packets', 'Weekly settlement summary'], keyword: 'semi truck dispatch service' },
    ...
    included: [
      ...
      'Percentage of weekly gross only: no flat rate, no setup fee',
    ],
    packages: [
      { name: 'Starter', tagline: 'One truck, standard hours.', priceRow: 'semi', anchor: 'low', features: ['Single truck', 'Load booking and rate negotiation', 'Broker setup and packets', 'Same-day invoicing', 'Weekday coverage'] },
      { name: 'Growth', tagline: 'Small fleet with claims handling.', priceRow: 'semi', anchor: 'mid', popular: true, features: ['Two to five trucks', 'Named dispatcher', 'Detention and layover claims', 'Factoring submission', 'Weekly settlement summary', 'Extended hours'] },
      { name: 'Pro', tagline: 'Fleet with 24/7 desk.', priceRow: 'semi', anchor: 'high', features: ['Six or more trucks', 'Dedicated dispatch team', 'After-hours and weekend desk', 'Lane and revenue analytics', 'Compliance support', 'Named account manager'] },
    ],
    process: [
    ...
    faqs: [
      { q: 'How much does truck dispatch cost?', a: 'Semi trucks (dry van, reefer, flatbed, step deck, power only) pay 5-6% of weekly gross, and small trucks (box truck, straight truck, hotshot) pay 8-10%, for OTR operations. On a semi grossing $8,000-$10,000 a week that is about $400-$600 a week. The final percentage is discussed with each carrier.' },
      { q: 'Is there a flat weekly fee?', a: 'No. We charge a percentage of weekly gross only. There is no flat rate, no setup fee and no monthly subscription. Local and regional work is quoted separately.' },
      ...
      { q: 'Why do small trucks pay a higher percentage than semis?', a: 'Box truck and hotshot loads are smaller and more frequent, so each truck needs more calls, broker setups and paperwork per dollar of gross. That is why small trucks are 8-10% and semis 5-6%.' },
    ...
    metrics: [
      { label: 'Semi rate', value: '5-6% of gross' },
      { label: 'Box truck & hotshot', value: '8-10% of gross' },
