            ...
            <Reveal>
              <ul className="space-y-4">
                {[
                  ...
                  ['The fee base is stated', 'Dispatch percentages apply to linehaul only. AdSense uplift is measured against an agreed baseline. Ads fees are the lower of flat or percentage.'],
                ].map(([title, body]) => (
