...
const BASE_SERVICES: Service[] = [
...

  {
    ...
    subServices: [
      { slug: 'box-truck-hotshot', name: 'Box truck and hotshot', summary: 'Hotshots 8%, box trucks and straight trucks 10% of weekly gross (OTR).', body: 'The lanes and load boards for box truck and hotshot work are different from semi freight. We run them daily and know which brokers pay on time.', deliverables: ['Daily load booking', 'Rate negotiation', 'Broker setup', 'Invoicing support', 'Lane planning'], keyword: 'box truck dispatch service' },
      { slug: 'semi-dispatch', name: 'Semi dispatch', summary: 'Dry van, reefer, flatbed, step deck and power only.', body: 'Equipment-specific dispatch with the permits, securement and temperature rules that go with it, at 5% of weekly gross for OTR semis. No flat rate.', deliverables: ['Equipment-matched loads', 'Permit and securement guidance', 'Rate negotiation', 'Broker packets', 'Weekly settlement summary'], keyword: 'semi truck dispatch service' },
    ...
    faqs: [
      { q: 'How much does truck dispatch cost?', a: 'Semi trucks (dry van, reefer, flatbed, step deck, power only) pay 5% of weekly gross, hotshots 8%, and box trucks and straight trucks 10%, for OTR operations. On a semi grossing $8,000-$10,000 a week that is about $400-$500 a week. The final percentage is discussed with each carrier.' },
      ...
      { q: 'Why do small trucks pay a higher percentage than semis?', a: 'Box truck and hotshot loads are smaller and more frequent, so each truck needs more calls, broker setups and paperwork per dollar of gross. That is why hotshots are 8%, box trucks 10% and semis 5%.' },
    ...
    metrics: [
      { label: 'Semi rate', value: '5% of gross' },
      { label: 'Hotshot / box truck', value: '8% / 10% of gross' },
